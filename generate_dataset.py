...
for i in range(1):
    ...
    file_name = f"imagen6_colores_random.png"
...
"""metadata = {
    file_name: {
        "valohai.dataset-versions": ["dataset://agranado-dataset/v5"]
    }
...
metadata = {
    relative_path: {
        "valohai.dataset-versions": [{
            'uri': "dataset://agranado-dataset/v6",
            'from': "dataset://agranado-dataset/v5",
            'start_fresh': False
        }]
    }
}
